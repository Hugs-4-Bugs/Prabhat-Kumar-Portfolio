...
export const siteConfig = {
  ...
  workExperience: [
    ...
    { date: "Jan 2023 – April 2025", title: "Backend Developer", company: "JMR Infotech Pvt Ltd", description: "Developed secure login/signup system using Spring Security & JWT, designed robust data models with Hibernate/JPA, and created custom exception handlers. Collaborated with frontend & QA teams for smooth integration. Engineered blog management APIs (create, edit, delete, like/dislike) and contributed to real-time property listing features.", tags: ["Java", "Spring Boot", "Hibernate", "MySQL", "JWT", "Postman", "RESTful API"] },
    { date: "Oct 2022 – Dec 2022", title: "Java Software Engineer Intern", company: "CodeSpeedy Technology Pvt Ltd", description: "Built backend authentication modules with Spring Boot & JWT. Managed entity relationships with Hibernate ORM and applied custom exception handling & HTTP status practices.", tags: ["Java", "Spring Boot", "Hibernate", "JWT", "MySQL", "Spring Security", "Postman"] },
    { date: "2022", title: "Remote Job Simulation", company: "Walmart USA", description: "Completed Advanced Software Engineering simulations. Designed custom heap in Java for shipping logistics and built UML/ER diagrams for complex systems.", tags: ["Java", "System Design", "UML", "Data Structures"] },
  ] as TimelineEvent[],

  education: [
      { date: "2019-2023", title: "Bachelor of Engineering, Computer Science", company: "Visvesvaraya Technological University", description: "", tags: [] },
      { date: "2016-2018", title: "Pre-University Course", company: "Veer Kunwar Singh University", description: "", tags: [] },
      { date: "2016", title: "Secondary School", company: "St. Anne's Mission School", description: "", tags: [] }
  ] as Education[],

  projects: [
    {
      name: 'Ollama Spring Boot AI Integration',
      description: 'Streaming AI responses via Spring AI & Flux. Built a real-time streaming AI interface using Spring AI + Ollama LLMs + WebFlux, enabling continuous responses for chat applications.',
      tags: ['Spring Boot', 'Ollama', 'Spring AI', 'LLMs', 'WebFlux'],
    ...
    },
     {
      ...
      description: 'Integrated OpenAI GPT API into Spring Boot to develop chat/voice AI. Created reusable modules for sending prompts and getting completions for chatbot-style applications.',
      tags: ['Spring Boot', 'OpenAI', 'REST API', 'AI'],
    ...
    },
    {
      ...
      description: 'A full-scale payment system supporting UPI, Wallets (Paytm, PhonePe, Mobikwik), and Cards. Features saved payment methods, QR Scan functionality, and redirection handling, all integrated into the business backend logic.',
      tags: ['Spring Boot', 'Payments', 'MySQL', 'E-commerce'],
    ...
    },
    {
      ...
      description: 'Developed at JMR Infotech, this module features Blog CRUD APIs with like/dislike logic and real-time property listing and content updates.',
      tags: ['Spring Boot', 'REST API', 'MySQL', 'Professional'],
      link: '#experience',
      image: '/images/articlehub.png',
      imageAiHint: 'real estate blog ui'
    },
    {
      name: 'E-commerce Auth System',
      description: 'A secure authentication system built with Spring Security & JWT. Features custom login/signup APIs and was developed in collaboration with frontend and QA teams.',
      tags: ['Spring Boot', 'JWT', 'Spring Security', 'E-commerce'],
      link: '#experience',
      image: '/images/RestAPI.png',
      imageAiHint: 'authentication system diagram'
    },
    {
      name: 'LinkedIn Clone',
      description: 'A Spring Boot backend simulating LinkedIn-like social features, including profile data management, feeds, and connection requests.',
      tags: ['Spring Boot', 'Microservices', 'API Gateway', 'Social'],
    ...
    },
    {
      ...
      description: 'A robust and secure mobile banking system for handling transactions, OTP verification, and account management.',
      tags: ['Spring Boot', 'Banking', 'MySQL', 'Security'],
    ...
    {
      name: 'Uber App Clone',
      description: 'Backend for a ride-hailing app, handling ride booking, driver allocation, trip history, and location-based features.',
      tags: ['Spring Boot', 'Maps API', 'Backend'],
    ...
    },
    {
      ...
      description: 'A full-featured airline booking platform using Spring Boot. Supports flight search, booking, ticket management, and check-in with secure authentication.',
      tags: ['Spring Boot', 'Thymeleaf', 'MySQL', 'Web'],
    ...
    },
    {
      ...
      description: 'A full-stack hospital management app with admin panels, report downloads, and service tracking. Uses Spring Boot and Thymeleaf.',
    ...
    },
     {
      ...
      description: 'Java-based QR code generator that accepts text input and outputs custom QR codes. Includes REST endpoints for integration.',
      tags: ['Java', 'QR Code', 'Spring Boot', 'Utility'],
      link: 'https://github.com/Hugs-4-Bugs/QR-code-Generator',
      image: '/images/qrcode.png',
      imageAiHint: 'qr code generator'
    },
    {
      name: 'Multiple File Upload System',
      description: 'Spring Boot REST API for uploading multiple files to a database using Spring Data JPA. Supports multipart handling.',
      tags: ['Spring Boot', 'REST API', 'File Upload', 'Utility'],
    ...
    {
      name: 'Bitcoin Mining Simulation',
      description: 'A Spring Boot project simulating Bitcoin mining operations with account management, transactions, and audit logging. Integrates BitcoinJ and REST APIs.',
      tags: ['Spring Boot', 'BitcoinJ', 'MySQL', 'Finance'],
    ...
    },
    {
      ...
      description: 'A machine learning-based app that predicts Bitcoin prices using historical data. Demonstrates data preprocessing, model training, and performance evaluation.',
      tags: ['Python', 'Machine Learning', 'Finance', 'AI'],
    ...
    },
    {
      ...
      description: 'Automates contributions to restore broken GitHub streaks using Node.js and Git. Also tracks contributions visually.',
      ...
      imageAiHint: 'github contribution graph'
    },
    {
      name: 'Awesome Portfolio Collection',
      description: 'A curated collection of 100+ portfolio templates built using HTML, CSS, and JavaScript. Includes a Google Chrome tab-style UI.',
      tags: ['HTML', 'CSS', 'JavaScript', 'UI Design', 'Resources'],
    ...
    },
     {
      ...
      description: 'A custom AI assistant chatbot for Prabhat that uses prompt engineering and context memory to hold conversations.',
      tags: ['JavaScript', 'AI', 'Chatbot', 'Node.js'],
    ...
    {
      name: 'AlgoByPrabhat',
      description: 'A learning hub for algorithmic trading models and concepts like FVG, Order Blocks, and liquidity analysis.',
      tags: ['JavaScript', 'Algorithms', 'Finance', 'Trading'],
    ...
    {
      name: 'Custom System Tools',
      description: 'Visionary projects including a custom Operating System, Game Engine, Database, AI Compiler, Visualization Machine, and Web Server, all built from scratch to reimagine core computing building blocks.',
      tags: ['System Design', 'AI', 'Innovation', 'R&D'],
      link: '#',
      image: '/images/quantumfusionsolution.png',
      imageAiHint: 'abstract system architecture'
    }
  ] as Project[],
  ...
  skills: [
    ...
    },
    {
      category: "Frontend",
      icon: ScreenShare,
      skills: ["React", "Redux", "Framer Motion", "Tailwind CSS", "Terminal UI"]
    },
     {
