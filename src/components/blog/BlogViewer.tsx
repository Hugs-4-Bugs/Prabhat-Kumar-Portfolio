...
export function BlogViewer({ blog, onClose }: BlogViewerProps) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="fixed top-0 left-0 right-0 h-1 bg-cyan-400 origin-left z-10"
      ...
      <motion.button
        onClick={onClose}
        className="fixed top-6 right-6 p-2 rounded-full bg-slate-800/50 hover:bg-slate-700/80 text-white z-20"
